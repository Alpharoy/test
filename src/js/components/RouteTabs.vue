<template>
    <el-tabs @tab-click="onTabClick" type="card" @tab-remove="onTabRemove" :value="value" :closable="closeable"
             class="header-tabs">
        <el-tab-pane v-for="pane in namedPanes" :name="pane.name" :label="pane.label" :key="pane.name"/>
    </el-tabs>
</template>
<script>
    export default {
