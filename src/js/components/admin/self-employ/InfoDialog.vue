<template>
    <el-dialog title="个体新增/编辑" :visible="elVisible" @close="onClose(false)" @open="onOpen" v-bind="$attrs"
               width="1200px"
               class="ql-dialog">
                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="公司名称" required>
                            <el-input v-model="selfEmploy.self_employ_name" maxlength="32"
                                      placeholder="请输入公司名称" :disabled="!creating"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="行业类型">
                            <el-select v-model="selfEmploy.industry_type_code" placeholder="请选择" style="width: 100%;"
                                       clearable>
                    ...
                    <el-col :span="8">
                        <el-form-item label="所在区域">
                            <ur-area-cascader v-model="selfEmploy.location_code" :level="4"
                                              select-any-level></ur-area-cascader>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="统一信用代码" required>
                            <el-input v-model="selfEmploy.usci_number" maxlength="32"
                                      placeholder="请输入统一信用代码" :disabled="!creating"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="企业法人" required>
                            <el-input v-model="selfEmploy.artificial_person_name" maxlength="32"
                                      placeholder="请输入企业法人"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="法人手机号码">
                            <el-input v-model="selfEmploy.artificial_person_phone_number" maxlength="11"
                                      placeholder="请输入法人手机号码"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="法人证件类型">
                            <el-select v-model="selfEmploy.artificial_person_certificate_type_code" placeholder="请选择"
                                       style="width: 100%;"
                                       clearable>
                    ...
                    <el-col :span="8">
                        <el-form-item label="法人证件号码">
                            <el-input v-model="selfEmploy.artificial_person_certificate_number" maxlength="32"
                                      placeholder="请输入法人证件号码"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="邮箱">
                            <el-input v-model="selfEmploy.email" maxlength="32"
                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="公司营业执照" required>
                            <el-input v-model="selfEmploy.business_license_photo" type="hidden"
                        ...
                        <el-row>
                            <el-col :span="12">
                                <el-form-item label="营业地址">
                                    <el-input v-model="selfEmploy.business_address" maxlength="32"
                                              placeholder="请输入营业地址"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="企业电话">
                                    <el-input v-model="selfEmploy.telephone" maxlength="32"
                                              placeholder="请输入企业电话"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="24">
                                <el-form-item label="经营范围">
                                    <el-input v-model="selfEmploy.business_scope" maxlength="64"
                                              placeholder="请输入经营范围"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="企业联系人" required>
                                    <el-input v-model="selfEmploy.contact_name" maxlength="32"
                                              placeholder="请输入企业联系人"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="联系人手机" required>
                                    <el-input v-model="selfEmploy.contact_phone_number" maxlength="11"
                                              placeholder="请输入企业联系人手机"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="24">
                                <el-form-item label="公司介绍">
                                    <el-input type="textarea" v-model="selfEmploy.introduce" maxlength="255"
                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="税号" required>
                            <el-input v-model="selfEmploy.tax_identification_number" maxlength="32"
                                      placeholder="请输入税号"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="发票抬头" required>
                            <el-input v-model="selfEmploy.invoice_title" maxlength="64"
                                      placeholder="请输入发票抬头"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="开户银行" required>
                            <el-input v-model="selfEmploy.bank_name" maxlength="32"
                                      placeholder="请输入开户银行"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="银行账号" required>
                            <el-input v-model="selfEmploy.bank_account" maxlength="32"
                                      placeholder="请输入银行账号"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="电话号码" required>
                            <el-input v-model="selfEmploy.bank_reserve_mobile_number" maxlength="11"
                                      placeholder="请输入电话号码"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="单位地址" required>
                            <el-input v-model="selfEmploy.invoice_address" maxlength="255"
        ...
        <div slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="auditPassedFunc" v-if="isAudit && selfEmploy.can_audit_passed">审核通过
            </el-button>
            <el-button type="danger" @click="auditFailedFunc" v-if="isAudit && selfEmploy.can_audit_failed">审核不通过
            </el-button>
            <el-button type="warning" @click="reverseAuditFunc" v-if="isAudit && selfEmploy.can_reverse_audit">撤销审核
            </el-button>
        </div>
    </el-dialog>
</template>
<script>
    ...
    export default {
        ...
        methods: {
            onOpen() {
                if (!this.creating) {
                    api.admin().get(helpers.convertURL(adminURL.get_self_employ, {selfEmployUUID: this.selfEmployUUID})).then((response) => {
                        this.selfEmploy = response.data;
            ...
            onClose(refresh = false) {
                ...
                helpers.restoreDataToDefault(this, ['selfEmploy', 'user', 'businessLicensePhoto']);
            ...
            submitFunc() {
                if (this.creating) {
                    api.admin().post(helpers.convertURL(adminURL.add_self_employ), {
                        self_employ: this.selfEmploy,
                        user: this.user
                    }).then(() => {
                        this.$message({type: 'success', message: '新增个体成功'});
                        this.onClose(true);
                    });
                } else {
                    api.admin().put(helpers.convertURL(adminURL.update_self_employ, {selfEmployUUID: this.selfEmployUUID}), this.selfEmploy).then(() => {
                        this.$message({type: 'success', message: '编辑个体成功'});
                        this.onClose(true);
                    });
                }
            },
            businessLicensePhotoUploadSuccess(imageCode) {
                this.selfEmploy.business_license_photo = imageCode;
            },
            businessLicensePhotoUploadRemove() {
                this.selfEmploy.business_license_photo = '';
            },
            auditPassedFunc() {
                this.$confirm('将审核个体成功，审核完成后不能撤销', '提示', {type: 'warning'}).then(() => {
                    this.auditFunc(99);
                }).catch(() => {
                });
            },
            auditFailedFunc() {
                this.$confirm('将审核个体状态为失败，确定吗？', '提示', {type: 'warning'}).then(() => {
                    this.auditFunc(80);
                }).catch(() => {
                });
            },
            ...
            auditFunc(auditStatus) {
                api.admin().post(helpers.convertURL(adminURL.self_employ_audit_status, {selfEmployUUID: this.selfEmployUUID}), {
                    audit_status: auditStatus
                }).then(() => {
                    this.$message({type: 'success', message: '审核个体完成'});
                    this.onClose(true);
                })
            },
        },
