...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            fetchData() {
                api.enterprise().get(helpers.convertURL(enterpriseURL.enterprise_user_log_list,{enterpriseUUID:this.enterpriseUuid,userUUID: this.uuid}), helpers.buildQuery(this.currentPage, {})).then(response => {
