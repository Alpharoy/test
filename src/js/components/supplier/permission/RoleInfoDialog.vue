...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            fetchMenu() {
                api.supplier().get(helpers.convertURL(supplierURL.menu_list), {group: this.group}).then((response) => {
            ...
            fetchRole() {
                api.supplier().get(helpers.convertURL(supplierURL.get_role, {id: this.id})).then((response) => {
            ...
            submitCreate() {
                ...
                api.supplier().post(helpers.convertURL(supplierURL.add_role), this.role).then(response => {
            ...
            submitUpdate() {
                this.role.menu_ids = this.$refs.menuTree.getCheckedKeys();
                api.supplier().patch(helpers.convertURL(supplierURL.update_role, {id: this.id}), this.role).then(response => {
