                    ...
                    <el-col :span="8">
                        <el-form-item label="公司营业执照">
                            <picture-upload
                                    ...
                                    :limit="1"
                                    :file-list="businessLicensePhoto" disabled></picture-upload>
                        </el-form-item>
                    </el-col>
                    <el-col :span="16">
                        <el-row>
...
<script>
    ...
    export default {
        ...
        methods: {
            onOpen() {
                api.supplier().get(helpers.convertURL(supplierURL.get_supplier_self_employ, {selfEmployUUID: this.selfEmployUUID})).then((response) => {
