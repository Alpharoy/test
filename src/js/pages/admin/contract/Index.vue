<template>
    <div class="flex-container">
        ...
        <el-card-table :list-data="listData">
            ...
            <el-table-column prop="contract_no" label="合约编码" width="150"/>
...
<script>
    ...
    import InfoDialog from '../../../components/admin/contract/InfoDialog';
    ...
    export default {
        ...
        methods: {
            ...
            fetchContract(page, query) {
                api.admin().get(this.convertURL(adminURL.contract_list), helpers.buildQuery(page, query)).then(response => {
