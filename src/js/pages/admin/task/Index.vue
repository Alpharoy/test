<template>
    <div class="flex-container">
        ...
        <info-dialog :visible.sync="showInfoDialog" :task-uuid="infoTaskUUID"></info-dialog>
    </div>
</template>
<script>
    import api from '../../../api';
    ...
    import InfoDialog from '../../../components/admin/task/InfoDialog';
    ...
    export default {
        ...
        methods: {
            ...
            fetchTask(page, query) {
                api.admin().get(this.convertURL(adminURL.task_list), helpers.buildQuery(page, query)).then(response => {
